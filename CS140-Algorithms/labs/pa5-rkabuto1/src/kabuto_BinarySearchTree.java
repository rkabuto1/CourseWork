...
public class kabuto_BinarySearchTree implements BinarySearchTreeFunctions //TODO - touchup class name and the constructor to utilize your last name.
{
    ...
    public void insertNode(Node z)
    {
        ...
        if (z.equals(getNode(getRoot(), z.getKey())))
        {
            int count = getNode(getRoot(),z.getKey()).getCount();
            count++;
            getNode(getRoot(), z.getKey()).setCount(count);
            return;
        }
    ...
    public Node getMax(Node x)
    {
        ...
        while (!(currentNode.getRight() == null))
        {
            ...
            if (currentNode.getKey() > max.getKey())
            {
                max = currentNode;
            }
        }
    ...
    public Node getMin(Node x)
    {
        ...
        while (!(currentNode.getLeft() == null))
        {
            ...
            if (currentNode.getKey() < min.getKey())
            {
                min = currentNode;
            }
        }
    ...
    public Node getSuccessor(Node x)
    {
        ...
        while ((xParent != null) && (x == xParent.getRight())) 
        {
            x = xParent;
    ...
    public Node getPredecessor(Node x)
    {
        ...
        Node xParent = x.getParent();
        while ((xParent != null) && (x == xParent.getLeft())) 
        {
            x = xParent;
            xParent = xParent.getParent();
        }
