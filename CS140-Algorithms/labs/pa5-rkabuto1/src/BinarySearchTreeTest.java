...
{
	// use this binary search tree for the smaller tree
	kabuto_BinarySearchTree tree;
	
	// use this binary search tree for the 31 key tree
	kabuto_BinarySearchTree t;
	...
	void setUp() throws Exception 
	{
		...
		tree = new kabuto_BinarySearchTree();
		
		// tree to use for the tests related to the 31 key tree
		t = new kabuto_BinarySearchTree();
	...
	void testGetHeight() 
	{
	    // check the height of the 31 key tree
