...
class kabuto_BankAccount
{
	...
	kabuto_BankAccount(String ownerLastName, String ownerFirstName, double checkingBalance, double savingsBalance)
	{
	...
	kabuto_BankAccount(String ownerLastName, String ownerFirstName)
	{
