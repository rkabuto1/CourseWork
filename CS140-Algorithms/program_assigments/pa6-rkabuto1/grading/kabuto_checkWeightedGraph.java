class kabuto_checkWeightedGraph
{
	...
	public static void main(String[] args)
	{
		...
		for( int i = 0; i < filenames.length; i++ )
		{
			...
			try
			{
				...
				WeightedEdge[] path = g.getPath(fromVertices[i], toVertices[i]);
		...
		System.err.println("kabuto" + finalResults);
	}
	
	public static WeightedGraphFunctions getGraph(String filename)
	{
		WeightedGraphFunctions g = new kabuto_WeightedGraph();
