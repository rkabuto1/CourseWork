...
int times(void); //Added Times
int divide(void); //Added Divide
int dividestail(int lefthandside); //Added the recursive tail
// -=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=-
int term(void);
int factor(void);
int number(void);
...
// -=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=-
// TODO: Correct Expr & Minus 
// TODO: Add Times & Factor
int expr(void) { 
  int result = minus();
  if (token == '+') {
    match('+');
...
int divide(void) {
  ...
  return dividestail(lefthandside);
}
int dividestail(int lefthandside) {
  if (token == '/') {
    match('/');
    ...
    return dividestail(lefthandside / righthandside);
  }
  return lefthandside;
}
// -=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=--=-=-=-
